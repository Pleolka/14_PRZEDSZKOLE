  ...
  render() {
    const listContent1 =
      this.state.isActive === "1" ? (
        ...
        <TabContents style={{ display: "none" }} dataTab="1" />
      )
    const listContent2 =
    ...
    const listContent4 =
      this.state.isActive === "4" ? (
        <TabContents className={""} dataTab="4" content={this.props.wyniki} />
      ) : (
        <TabContents style={{ display: "none" }} dataTab="4" />
      )
    const listContent5 =
      this.state.isActive === "5" ? (
        <TabContents className={""} dataTab="5" content={this.props.warunki} />
      ) : (
        <TabContents style={{ display: "none" }} dataTab="5" />
      )
    return (
